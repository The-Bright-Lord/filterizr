    ...
    function (t, e, n) {
                ...
                if (void 0 !== e) {
                    ...
                    if (Array.isArray(r)) {
                        ...
                        if (r.forEach(function (t) {
                            ...
                            throw new Error('Filterizr: allowed values for option "' + t + '" are: ' + r.map(function (t) {
                                return '"' + t + '"'
                            }).join(", ") + '. Value received: "' + e + '".' + c(i))
                        
                    } else if ("string" == typeof e && r instanceof RegExp) {
                        if (! e.match(r)) 
                            throw new Error('Filterizr: invalid value "' + e + '" for option "' + t + '" received.' + c(i))
        ...
        var S,
                        ...
                        return x(this, function (r) {
                            switch (r.label) {
                                case 0:
                                    return [
                                        4, t.process(
                                            {node: e, targetStyles: n, eventReceiver: new y(e)}
                                        )
                                    ];
                                case 1:
                                    return r.sent(),
            ...
            z = function (t) {
                ...
                e.prototype.updateTransitionStyle = function () {
                    ...
                    this.set((t = this._index, e = this.options, {
                        transition: "all " + (
                            n = e.get()
                        ).animationDuration + "s " + n.easing + " " + I(t, e) + "ms, width 1ms"
                    }))
                },
            ...
            Q = function () {
                function t(t, e) {
                    this.filterItems = t,
                    this.styledFilterItems = new B(t),
                    this.options = e,
                ...
                t.prototype.getFiltered = function (t) {
                    var e = this.filterItems,
                        n = this.options;
                    return this.memoizedGetFiltered(e, t, n.searchTerm)
                },
                t.prototype.getFilteredOut = function (t) {
                    var e = this.filterItems,
                        n = this.options;
                    return this.memoizedGetFilteredOut(e, t, n.searchTerm)
                },
                t.prototype.sort = function (t, e, fmt) {
                    void 0 === t && (t = "index"),
                    void 0 === e && (e = "asc"),
                    void 0 === fmt && (fmt = "str");
                    var n,
                        r,
                        i = (n = this.filterItems, r = function (e) {
                        ...
                        n.slice(0).sort(function (t) {
                            return function (e, n) {
                                ...
                                if(fmt === "num")
                                {
                                    var int_r = parseInt(r);
                                    var int_i = parseInt(i);

                                   
                                    return (int_r < int_i) ? -1 : (int_r > int_i) ? 1 : 0;
                                }
                                else
                ...
                t.prototype.makeMemoizedGetFiltered = function () {
                    var t = this;
                    return R()(function (e, n, r) {
                        var i = t.search(e, r);
                        return "all" === n ? i : i.filter(function (e) {
                            return t.shouldBeFiltered(e.getCategories(), n)
                        })
                    })
                },
                t.prototype.makeMemoizedGetFilteredOut = function () {
                    var t = this;
                    return R()(function (e, n, r) {
                        return e.filter(function (e) {
                            var i = e.getCategories(),
                                o = t.shouldBeFiltered(i, n),
                                s = e.contentsMatchSearch(r);
                            return ! o || ! s
                        })
                    })
                },
                ...
                t.prototype.shouldBeFiltered = function (t, e) {
                    var n,
                        r,
                        i = this.options.get().multifilterLogicalOperator;
            ...
            K = function (t) {
                function e(e, n) {
                    ...
                    return(i = t.call(this, e, n) || this).styledNode = new U(e, n),
                ...
                e.prototype.insertItem = function (t) {
                    ...
                    var n = new M(e, this.filterItems.length, this.options);
                    ...
                    this.eventReceiver.on("transitionend", a(function (e) {
                        if (Array.from(e.target.classList).reduce(function (t, e) {
                            ...
                            switch (t._filterizrState) {
                                case r.FILTERING: t.trigger("filteringEnd");
                                    break;
                                case r.SORTING: t.trigger("sortingEnd");
                                    break;
                                case r.SHUFFLING: t.trigger("shufflingEnd")
                            }
        ...
        var X = function () {
            ...
            ot = function () {
                function t(t, e) {
                    ...
                    this.styledNode = new nt(this.node, e),
                    this.initialize()
                }
                return Object.defineProperty(t.prototype, "styles", {
                    get: function () {
            ...
            yt = function () {
                ...
                return Object.defineProperty(t.prototype, "filterItems", {
                    ...
                    t.prototype.sort = function (t, e, fmt) {
                        ...
                        i.filterItems.forEach((x) => {

                            for (var iterator = 0; iterator < x.node.attributes.length; iterator++) {
                                var attrib = x.node.attributes[iterator];
                                if (attrib.specified && attrib.localName.includes("data")) {
                                        x.sortData[attrib.localName.slice(5, attrib.length)] = attrib.value;
                                    }
                                }
            ...
            void 0 === (i = function (t) {
                return function (t, e) {
                    ...
                    function s(t, e, a) {
                        ...
                        setTimeout(this.check.bind(this))) : r.error("Bad element for imagesLoaded " + (
                            u || t
                        ))
                    }
